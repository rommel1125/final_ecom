...
<body style="background-color:white" onload="totalprice()" >
  ...
  <header id="header"><!--header-->
          ...
          <div class="col-sm-6">
            <div class="contactinfo">
              <ul class="nav nav-pills">
                <li><a href="#"><i class="fa fa-phone"></i> 05456056</a></li>
                <li><a href="#"><i class="fa fa-envelope"></i> rommelfrogoso.rjf11@gmail.com</a></li>
              </ul>
            </div>
          </div>
          <div class="col-sm-6">
    ...
    <div class="footer-bottom">
      <div class="container">
        <div class="row">
          <p class="pull-left">Modified by <span><a href="https://www.facebook.com/stevenjohn.baritua">Steven</a></span></p>
          <p class="pull-right">Designed by <span><a target="_blank" href="https://www.facebook.com/rommeljohn.frogoso">Rommel</a></span></p>
        </div>
      </div>
    </div>
